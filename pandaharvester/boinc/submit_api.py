...
class BATCH_DESC:
    ...
    def to_xml(self, op):
        ...
        if hasattr(self, 'input_template_filename'):
           xml += '<input_template_filename>%s</input_template_filename>\n'%self.input_template_filename
        if hasattr(self, 'output_template_filename'):
           xml += '<output_template_filename>%s</output_template_filename>\n'%self.output_template_filename
